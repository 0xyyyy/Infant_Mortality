...
def combined_df():
    ...
    results = session.query(combined.ID, combined.State, combined.Infant_Death_Rate, combined.Infant_Deaths, combined.Low_Birthweight_Rate, combined.Year, combined.Median_Income, combined.Teen_Birth_Rate, combined.Unmarried_Birth_Rate)

    session.close()

    combined_info = []
    for ID, State, Infant_Death_Rate, Infant_Deaths, Low_Birthweight_Rate, Year, Median_Income, Teen_Birth_Rate, Unmarried_Birth_Rate in results:
        combined_dict = {}
        combined_dict["ID"] = ID,
        combined_dict["State"] = State,
        combined_dict["Infant_Death_Rate"] = Infant_Death_Rate,
        combined_dict["Infant_Deaths"] = Infant_Deaths,
        combined_dict["Year"] = Year,
        combined_dict["Median_Income"] = Median_Income,
        combined_dict["Teen_Birth_Rate"] = Teen_Birth_Rate,
